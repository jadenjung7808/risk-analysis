...
st.markdown("Enter stocks and amounts to analyze portfolio risk based on 10 key indicators.")
...
# Hidden Risk % Explanation
with st.expander("📘 risk %?"):
    st.markdown("""
    **The risk percentage** represents how risky your stock or portfolio is on a scale from 0 to 100, based on valuation, volatility, debt, and profitability.
